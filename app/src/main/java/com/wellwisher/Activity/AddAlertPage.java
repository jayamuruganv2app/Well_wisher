...
public class AddAlertPage extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userid = PreferenceManager.getDefaultSharedPreferences(AddAlertPage.this).getString("userid", "");
        ...
        Liner_data_picker .setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AddAlertPage.this, date, myCalendar
    ...
    private void Relationship_type_API() {
        ...
        dialog = ProgressDialog.show(AddAlertPage.this, Constants.PLEASE_WAIT, Constants.LOADING, true);
    ...
    private void submitformSubmitApi() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AddAlertPage.this);
        requestQueue.add(stringRequest);
    }
    public void Signup_Response(JSONObject object) {
        try {
            ...
            if (status.equals("true")) {
                ...
                // otpflag=false;
                Toast.makeText(AddAlertPage.this, message, Toast.LENGTH_LONG).show();
